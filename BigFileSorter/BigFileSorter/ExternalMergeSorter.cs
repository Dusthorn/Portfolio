namespace BigFileSorter
  ...
  public class ExternalMergeSorter
    ...
    public ExternalMergeSorter()
      : this(new ExternalMergeSorterOptions())
      {
      }
    ...
    /// Деление файла
    /// </summary>
    /// <param name="sourceStream">Источник</param>
    /// <param name="cancellationToken">Токен отмены</param>
    /// <returns></returns>
    ...
    /// Сортировка файлов
    /// </summary>
    /// <param name="unsortedFiles">Несортированные файлы</param>
    /// <returns></returns>
    ...
    /// Сортировка файла
    /// </summary>
    /// <param name="unsortedFile">Несортированный файл</param>
    /// <param name="target">Цель</param>
    /// <returns></returns>
    ...
    /// Слияние файлов
    /// </summary>
    /// <param name="sortedFiles"> Сортированные файлы </param>
    /// <param name="target"> Цель </param>
    /// <param name="cancellationToken">Токен отмены</param>
    /// <returns></returns>
    private async Task MergeFiles(IReadOnlyList<string> sortedFiles, Stream target, CancellationToken cancellationToken)
      ...
      while (!done)
        ...
        var runs = sortedFiles.ChunkBy(runSize);
        var chunkCounter = 0;
    ...
    /// <summary>
    /// Создаёт a StreamReader для каждого источника.
    /// Читает одну строку с StreamReader для инициализации списка.
    /// </summary>
